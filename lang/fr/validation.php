 ...
 * `APP_FALLBACK_LOCALE=fr` : sans ce fichier, l'API renvoyait la clé brute
 * (`validation.unique`) que l'app mobile et le front affichent telle quelle.
 * `TraductionsFrancaisesTest` vérifie que chaque règle du framework a sa
 * traduction ici : une montée de version qui en ajoute une le signalera.
 */
...
return [
    ...
    /*
     * Noms lisibles des champs que l'usager remplit lui-même (inscription,
     * profil, recherche, dossiers). Les champs purement internes gardent
     * leur nom technique.
     */
    'attributes' => [
        'name' => 'nom',
