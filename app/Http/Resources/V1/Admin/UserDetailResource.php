...
class UserDetailResource extends JsonResource
{
    ...
    public function toArray(Request $request): array
    {
        ...
        return [
            ...
            // Vrai quand le compte est réellement bloqué tant qu'il n'est pas
            // vérifié : inscription depuis le 13/09/2026 ET blocage actif
            // (`auth.verification.enforce`, suspendu depuis le 25/09/2026,
            // mibeko-dashboard#206). La fiche affiche « bloqué » sur cette
            // valeur : elle doit dire ce que vit l'usager, pas la règle en veille.
            'email_verification_required' => $this->isEmailVerificationEnforced(),
