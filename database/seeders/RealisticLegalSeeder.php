...
class RealisticLegalSeeder extends Seeder
{
    public function run(): void
    {
        ...
        if ($constitution->wasRecentlyCreated) {
        ...
        // 2. Code du Travail
        $codeTravail = LegalDocument::firstOrCreate(
        ...
        if ($codeTravail->wasRecentlyCreated) {
        ...
        // 3. Code Civil
        $codeCivil = LegalDocument::firstOrCreate(
        ...
        if ($codeCivil->wasRecentlyCreated) {
        ...
        $loiDonnees = LegalDocument::firstOrCreate(
        ...
        if ($loiDonnees->wasRecentlyCreated) {
            ...
            $art1->versions()->create([
                'contenu_texte' => 'La présente loi fixe le cadre juridique applicable à la protection des données à caractère personnel.',
