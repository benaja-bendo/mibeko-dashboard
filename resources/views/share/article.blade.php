...
<head>
    ...
    <meta name="apple-itunes-app" content="app-id=YOUR_APP_STORE_ID, app-argument=mibeko://article/{{ $article->id }}">
...
<body>
    ...
    <script>
        // Optional: Auto-redirect to app after 2 seconds if mobile
        /*
        setTimeout(function() {
            window.location.href = "mibeko://article/{{ $article->id }}";
        }, 2000);
        */
    </script>
</body>
